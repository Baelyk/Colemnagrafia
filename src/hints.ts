...
import { COLORS, FONTS, SIZES, getTextHeight, scrolling, wrapText } from "./utils";

export function hints(_time: DOMHighResTimeStamp, game: Game, menuBarY: number, menuBarPadding: number, menuHeight: number, menuX: number) {
